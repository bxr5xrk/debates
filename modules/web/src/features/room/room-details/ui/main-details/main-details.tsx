...
export function MainDetails(props: MainDetailsProps): JSX.Element {
    ...
    return (
        <div className="p-4">
            <p className="bg-amber-400 w-max lg:min-w-[250px] text-center font-bold mx-auto text-[30px] md:text-[40px] lg:text-[50px] rounded-[20px] border border-black border-r-4 border-b-4 px-4 py-2">
            ...
            {status === "started"
                ...
                : <p className="text-amber-400 font-bold text-[25px] md:text-[30px] lg:text-[45px] mx-auto w-max border-text">Paused</p>
            }
